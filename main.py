...
from play_best import run_best_solutions
import numpy as np
...
for enemy_id in [2, 3, 5]:
    ...
    for i in range(number_of_runs):
        temp_fitness_avg_ex1 = run_best_solutions(sol_path_ex1 + str(i) + ".txt", ex1)
        temp_fitness_avg_ex2 = run_best_solutions(sol_path_ex2 + str(i) + ".txt", ex2)
